    ...
    return (
      <div style={{ height: "calc(100vh - 0px)" }}>
        <div className="page-home padded">
          ...
          <div className="lt-480">
            <br />
            <div className="bubble">{l(i18n.pages.home.content.realities.introduction)}</div>
          </div>
            ...
            <Link to={{ pathname: "/home/", state: { reality: "history", slave: true } }} href="/home">
              <div
                className={`reality-list-item ${
                  this.props.location.state && this.props.location.state.reality === "history" ? "selected" : ""
                }`}
              >
          ...
          <Link
            className="bubble"
            to={{ pathname: "/council", state: { memberSlug: "president", slave: true } }}
            href="/council"
          >
