...
class Footer extends Component {
  ...
  render() {
    return (<footer>
      ...
      <span className='footer-link'><a href='mailto:olga.jackson@lymphcon.ch' target="_blank">Contact</a></span>
      ...
      <span className='footer-copyright'>Copyright © 2018 IOR. All Rights Reserved</span>
    </footer>)
  }
