...
const modal = {
  ...
  DONATION_START: {
    content: {
      ...
      it: (
        <div className="modal-text">
          Stiamo processando la vostra transazione.
          <br />
          Verificando la validità della carta di credito...
        </div>
      )
    },
    title: {
  ...
  DONATION_SUCCESSFUL: {
    content: {
      en: (
        <div className="modal-text">
          You donated <ReadFromState text="/amount/" /> CHF.
          <br />A receipt has been sent to <ReadFromState text="/email/" />
        </div>
      ),
      it: (
        <div className="modal-text">
          Ha donato <ReadFromState text="/amount/" /> CHF.
          <br />
          Le abbiamo spedito una ricevuta a <ReadFromState text="/email/" />
        </div>
      )
    },
    title: {
  ...
  DONATION_FAILED: {
    content: {
      en: (
        <div className="modal-text">
          Your donation of <ReadFromState text="/amount/" /> CHF failed.
          <br />
          Please check your credit card and personal details and try again
        </div>
      ),
      it: (
        <div className="modal-text">
          La sua donazione di <ReadFromState text="/amount/" /> CHF è fallita.
          <br />
          Per favore controlli i dettagli della sua carta di credito e provi nuovamente
        </div>
      )
    },
    title: {
  ...
  content: {
    ...
    realities: {
      ...
      ielsg: {
        ...
        address: {
          en: "<b>International Extranodal Lymphoma Study Group</b>",
          it: "<b>International Extranodal Lymphoma Study Group</b>" // <br/><br/>Ospedale San Giovanni<br/>CH-6500 Bellinzona<br/><br/>+41 91 811 9040<br/><br/><a href=\'mailto:ielsg@eoc.ch\'>ielsg@eoc.ch</a>',
        }
      },
      icml: {
        acronym: {
...
const donations = {
  ...
  intro: {
    en:
      "Possible both online as well as via bank transfer or on our post office account.<br/><br/>Thank you for your support!",
  ...
  bankTransfer: {
    ...
    description: {
      en:
        "Banca dello Stato del Canton Ticino<br/>Via Pioda 7<br/>6900 Lugano<br/>Switzerland<br/><br/><b>IBAN code:</b> CH31 0076 4336 9742 C000 C<br/><b>SWIFT:</b> BSCTCH22LUG<br/><b>Clearing number:</b> 00764",
      it:
        "Banca dello Stato del Canton Ticino<br/>Via Pioda 7<br/>6900 Lugano<br/>Svizzera<br/><br/><b>Codice IBAN:</b> CH31 0076 4336 9742 C000 C<br/><b>SWIFT:</b> BSCTCH22LUG<br/><b>Clearing number:</b> 00764"
    }
  },
  post: {
    title: {
    ...
    description: {
      en:
        "PostFinance Ltd<br/>Mingerstrasse 20<br/>3030 Berna<br/>Switzerland<br/><br/><b>Post account nr.:</b> 65-433-5</br/><b>IBAN code:</b> CH91 0900 0000 6500 0433 5<br/><b>SWIFT:</b> POFICHBEXXX",
      it:
        "PostFinance Ltd<br/>Mingerstrasse 20<br/>3030 Berna<br/>Svizzera<br/><br/><b>no. CCP:</b> 65-433-5</br/><b>IBAN code:</b> CH91 0900 0000 6500 0433 5<br/><b>SWIFT:</b> POFICHBEXXX"
    }
  }
};
