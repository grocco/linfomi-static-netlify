...
const home = {
    title: {
        en: "The Foundation for the Institute of Oncology Research (Foundation IOR)",
        it: "La Fondazione per l\'Istituto oncologico di ricerca (Fondazione IOR)",
    },
    content: {
        thanks: {
        ...
        realities: {
            ...
            ior: {
                ...
                description: {
                    it: 'Lo <b>IOR</b> ha iniziato la sua attività nel 2003 all’interno dell’edificio dell’Istituto di ricerca in biomedicina (IRB) di Bellinzona. In pochi anni i ricercatori dello IOR si sono affermati a livello internazionale, pubblicando ricerche di grande originalità e di notevole impatto nelle principali riviste scientifiche mondiali. Inoltre questi ricercatori sono stati capaci di ottenere importanti contributi alla ricerca non solo dalle istanze nazionali svizzere, ma anche nell’ambito dei programmi molto selettivi dell’Unione Europea.<br/>Questa qualità eccellente è stata riconosciuta dapprima dal Segretariato di Ricerca del Consiglio Federale (SEFRI), che ha accordato allo IOR i molto ambiti sussidi federali, ed in seguito dall’Università della Svizzera Italiana (USI), che ha affiliato lo IOR nel 2016 nell’ambito della Facoltà di Biomedicina appena creata. A tutt’oggi (2018) quasi 70 persone lavorano nei laboratori dello IOR, con un budget annuale che si sta ormai avvicinando allo soglia del 10 milioni di franchi.',
                    en: 'The <b>IOR</b> (Institute of Oncology Research) started its activity in 2003 inside the building of the Institute for Research in Biomedicine  (IRB) in Bellinzona. In a few years, IOR researchers attained worldwide recognition through the publication of ground breaking research with a high impact in international leading scientific journals. Furthermore the researchers were able to obtain important  financial contributions both in Switzerland and from the extremely selective European Union programmes.<br/>This excellent quality level has been recognized first by the Research Secretariat of the Federal Council (SEFRI), which has granted to IOR the much sought-after federal subsides and later by the University of Southern Switzerland (USI), which affiliated the IOR in 2016 within the newly created Faculty of Biomedicine. To date  (2018) almost 70 people work in the laboratories of the IOR with an annual budget that is approaching the threshold of 10 million francs.'
                }
            },
            ielsg: {
                acronym: {
